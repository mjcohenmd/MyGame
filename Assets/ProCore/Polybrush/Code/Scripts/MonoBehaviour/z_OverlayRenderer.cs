...
namespace Polybrush
{
	...
	public class z_OverlayRenderer : z_ZoomOverride
	{
        ...
        private HideFlags SceneCameraHideFlags = (HideFlags) (1 | 4 | 8);
        ...
        private List<List<int>> common = null;
        private Color[] w_colors;
        private Color[] v_colors;
        private bool drawVertexBillboards = true;
