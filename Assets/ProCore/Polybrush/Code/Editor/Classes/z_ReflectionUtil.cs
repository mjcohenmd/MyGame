...
namespace Polybrush
{
    ...
    /// </summary>
    internal static class z_ReflectionUtil
	{
        private static EditorWindow m_PbEditor = null;
		public static bool enableWarnings = true;
        private const BindingFlags k_AllFlags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic;
        private static MethodInfo m_ProBuilderOptimize = null;
        private static MethodInfo m_ProBuilderRefreshNoArgs = null;
        private static MethodInfo m_ProBuilderRefresh = null;
        private static MethodInfo m_ProBuilderToMeshNoArgs = null;
        private static Type m_ProBuilderObjectType = null;
        private static Type m_ProBuilderEditorType = null;
        private static object[] m_RefreshArgs = new object[1];
        private static Dictionary<string, Type> m_CachedTypes = new Dictionary<string, Type>();
        private static readonly string[] k_EditorMeshUtilityTypeNames = new string[]
		{
        ...
        private static readonly string[] k_EditorTypeNames = new string[]
		{
			"ProBuilder.EditorCore.pb_Editor",
			"ProBuilder2.EditorCommon.pb_Editor",
		};
        private static readonly string[] k_PbObjectNames = new string[]
		{
			"pb_Object",
        ...
        /// <param name="assembly"></param>
        /// <returns></returns>
        private static Type GetTypeCached(string type, string assembly = null)
		{
			Type res = null;
        ...
        /// </summary>
        /// <returns></returns>
        private static MethodInfo ProBuilder_RefreshMethodInfo()
		{
        ...
        private static MethodInfo ProBuilder_RefreshWithMaskMethodInfo()
		{
        ...
        private static MethodInfo ProBuilderToMeshNoArgsMethodInfo
		{
			get
			{
