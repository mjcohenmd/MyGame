...
namespace Polybrush
{
	public static class z_EditorUtility
	{
        ...
        private const int DIALOG_OK = 0;
        private const int DIALOG_CANCEL = 1;
        private const int DIALOG_ALT = 2;
        private const string DO_NOT_SAVE = "DO_NOT_SAVE";
        ...
        private const string SHADER_ATTRIB_FILE_EXTENSION = "pbs.json";
