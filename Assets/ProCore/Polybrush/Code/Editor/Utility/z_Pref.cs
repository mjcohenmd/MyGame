...
namespace Polybrush
{
	...
	public static class z_Pref
	{
        ...
        private static readonly Dictionary<string, float> FloatDefaults = new Dictionary<string, float>()
		{
			{ vertexBillboardSize, 2f },
			{ pushPullEffect, 5f }
		};
        private static readonly Dictionary<string, bool> BoolDefaults = new Dictionary<string, bool>()
		{
        ...
        private static readonly Dictionary<string, Color> ColorDefaults = new Dictionary<string, Color>()
		{
			{ brushColor, new Color(0f, .8f, 1f, 1f) }
		};
        private static readonly Dictionary<string, int> EnumDefaults = new Dictionary<string, int>()
		{
        ...
        private const string DEFAULT_GRADIENT = "RGBA(0.227, 1.000, 0.227, 255.000)&0.000|RGBA(1.000, 1.000, 1.000, 255.000)&1.000|\n1.0000&0.000|0.2588&1.000|";
