...
namespace Polybrush
{
	...
	internal static class z_GUILayout
	{
        ...
        private static readonly Color texture_button_border = new Color(.1f, .1f, .1f, 1f);
        private static readonly Color texture_button_fill = new Color(.18f, .18f, .18f, 1f);

        private static bool AttributeComponentButton(Rect rect, string text, Texture2D img, bool selected)
		{
			bool clicked = false;
