...
namespace Polybrush
{
	...
	public class z_BakeAdditionalVertexStreams : EditorWindow
	{
        ...
        private void CreateComposite(z_AdditionalVertexStreams vertexStream, bool applyToCurrent, string path = null)
		{
        ...
        private void CreateCompositeMesh(Mesh source, Mesh vertexStream, Mesh composite)
		{
