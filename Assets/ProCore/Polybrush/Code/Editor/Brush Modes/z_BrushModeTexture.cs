...
namespace Polybrush
{
	...
	public class z_BrushModeTexture : z_BrushModeMesh
	{
        ...
        private z_PaintMode paintMode = z_PaintMode.Brush;
        private bool likelySupportsTextureBlending = true;

		[System.NonSerialized]
        private z_SplatSet 	splat_cache = null,
					splat_target = null,
					splat_erase = null,
					splat_current = null;

		[System.NonSerialized] private z_SplatWeight brushColor = null;
		[System.NonSerialized] private z_SplatWeight minWeights = null;
		[SerializeField] private int selectedAttributeIndex = -1;
