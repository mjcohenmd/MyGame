...
namespace Polybrush
{
	...
	{
        private const float SMOOTH_STRENGTH_MODIFIER = .1f;
        ...
        private Dictionary<int, List<int>> neighborLookup = new Dictionary<int, List<int>>();
        private List<List<int>> commonVertices = null;
        private int commonVertexCount;
