...
namespace Polybrush
{
	...
	public class z_BrushModePaint : z_BrushModeMesh
	{
        ...
        private const float STRENGTH_MODIFIER = 1f/8f;
		private static readonly Color32 WHITE = new Color32(255, 255, 255, 255);

		[SerializeField] private z_PaintMode paintMode = z_PaintMode.Brush;
		[SerializeField] private bool likelySupportsVertexColors = false;

		// mesh vertex colors
		[SerializeField] private Color32[] colors_cache = null, target_colors = null, erase_colors = null, colors = null;
		[SerializeField] private Color32 brushColor = Color.green;
        private z_ColorMask mask = new z_ColorMask(true, true, true, true);
        private z_ColorPalette[] availablePalettes = null;
        ...
        // used for fill mode
        private Dictionary<z_Edge, List<int>> triangleLookup = null;
		...
		[SerializeField] private z_ColorPalette _colorPalette = null;
		...
		[SerializeField] private z_ColorPaletteEditor _colorPaletteEditor = null;
