...
namespace Polybrush
{
	...
	{
        private const string PREFAB_PALETTE_PATH = "Prefab Palettes/Default.asset";
		...
		[SerializeField] private z_PrefabPalette _prefabPalette = null;
        private z_PrefabPalette[] availablePalettes = null;
        private string[] availablePalettes_str = null;
        ...
        private z_PrefabPaletteEditor prefabPaletteEditor = null;
        ...
        private static GUIContent gc_usePrefabPivot = new GUIContent("Use Pivot", "By default Polybrush will position placed objects entirely on top of the target plane.  When 'Use Pivot' is enabled objects will instead be placed by their assigned mesh origin.");
        private static GUIContent gc_hitSurfaceIsParent = new GUIContent("Hit Surface is Parent", "When enabled any instantiated prefab from this mode will be automatically made a child of the surface it was placed on.");
        private static GUIContent gc_avoidOverlappingGameObjects = new GUIContent("Avoid Overlap", "If enabled Polybrush will attempt to avoid placing prefabs where they may overlap with another placed GameObject.");

        private static string FormatInstanceName(GameObject go)
		{
