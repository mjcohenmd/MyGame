...
namespace Polybrush
{
	...
	public class z_ColorPaletteEditor : Editor
	{
        ...
        private DragState drag = new DragState();
        private const int DRAG_OVER_NULL = -1;
        private const int DRAG_OVER_TRASH = -42;
        private GUIContent gc_AddColorSwatch = new GUIContent( (Texture2D) null, "Add Selected Color to Palette");
        ...
        private int IncrementIndex(int index, int rowSize)
		{
			index++;
