...
namespace Polybrush
{
	...
	public class z_Editor : EditorWindow
	{
        ...
        private const double EDITOR_TARGET_FRAMERATE_LOW = .016667;
        private const double EDITOR_TARGET_FRAMERATE_HIGH = .03;
		...
		[SerializeField] private List<z_BrushMode> modes = new List<z_BrushMode>();
        ...
        private static bool VerifyCycleBrush()
		{
			return instance != null;
		}

		[MenuItem("Tools/Polybrush/Next Brush", false, 100)]
        private static void MenuCycleBrush()
		{
			if(instance != null)
			{
        ...
        private void SetWindowFloating(bool floating)
		{
        ...
        private void OnProBuilderEditLevelChanged(int i)
		{
			// Top = 0,
			// Geometry = 1,
			// Texture = 2,
        ...
        private void SetTool(z_BrushTool brushTool)
		{
        ...
        private double GetTargetFramerate(z_BrushTarget target)
		{
		 ...
		 */
        private z_BrushTarget GetBrushTarget(GameObject go)
		{
		 ...
		 */
        private void UpdateBrush(Vector2 mousePosition, bool isDrag = false)
		{
		 ...
		 */
        private bool DoMeshRaycast(Ray mouseRay, z_BrushTarget target)
		{
        ...
        private void OnBrushBeginApply(z_BrushTarget brushTarget, z_BrushSettings settings)
		{
        ...
        private void ScrollBrushSettings(Event e)
		{
			float nrm = 1f;
        ...
        private void OnBrushEnter(z_BrushTarget target, z_BrushSettings settings)
		{
			mode.OnBrushEnter(target.editableObject, settings);
		}

        private void OnBrushMove()
		{
			if( z_Util.IsValid(brushTarget) )
				mode.OnBrushMove( brushTarget, brushSettings );
		}

        private void OnBrushExit(GameObject go)
		{
        ...
        private void FinalizeAndResetHovering()
		{
			foreach(var kvp in hovering)
			{
